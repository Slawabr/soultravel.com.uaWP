        ...
        <div class="container">
          <div class="call-out-box">
            <div class="call-out-wrap alt">
              <h2 class="title-section alt-2 gray">Подыскать вам горящий тур</h2><a href="#"  onclick="$.fancybox('#ordertop');" class="cws-button border-left large alt mb-20">Оставить заявку</a>
            </div>
          </div>
        </div>
      </section>
          ...
          $tagslug = basename(get_permalink());
                    ...
                    if ($posts->have_posts()):
                        while ($posts->have_posts()) : $posts->the_post();
                            ...
                            ?>               
      <div class="features-tours-item">
        <div class="features-media"><img src="<?php echo $thumb_url [0];?>" alt="Горящие туры в <? echo  get_field('kuda');?>" >
          <div class="features-info-top">
            <div class="info-price font-4"></div>
            <p class="info-text"><? echo get_field('desc');?></p>
          </div>
          <div class="features-info-bot">
            <h4 class="title"><span class="font-4">Горящие туры в </span><? echo  get_field('kuda');?></h4>
