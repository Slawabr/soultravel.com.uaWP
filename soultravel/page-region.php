...
$posttags = get_the_tags();
  if ($posttags) {
             ...
             echo '<a href="/tours/'.$tag->slug.'/">'.$tag->name.'</a>' ;}
                                            }  ?>            
            <i>/</i> <span><?php the_title(); ?></span>
            <h1><span>Туры в </span> <?php the_title(); ?></h1>
            <div class="location">
...
<section class="page-section">
        <div class="container">
          <div class="row">
		  <div class="col-md-12">
              <h2 class="title-section">О курорте</h2>
...
<section class="page-section">
        <div class="container">
          <div class="row">
		  <div class="col-md-12">
              <h2 class="title-section">Туры и спецпредложения в <span> <?php the_title() ?></span></h2>
              <div class="cws_divider mb-25 mt-5"></div>
	<div class="row">
                    <?php
					$tagslug = basename(get_permalink());
...
<div class="recom-price"><span class="font-4"><? echo get_field('price');?></span> за <? echo  get_field('days');?> ночей</div>
