...
<?php
/*
Template Name: Раннее
Template post type: tours , ranee
*/
...
<section><div class="container"></div></section>
 ...
 echo $image_url[0]; ?>" 
    alt="<?php the_title(); ?>" class="cws_prlx_layer" style="transform: translate(-50%, -2.33932px);">

        <div class="container">
          <div class="text-left breadcrumbs-item"><a href="/">Главная</a><i>/</i><a href="/tours/ranee-bronirovanie/">Раннее бронирование</a><i>/</i>
            <h1><span>Раннее бронирование в </span> <?php echo get_field('kuda'); ?></h1>
            <div class="location">
...
<section class="page-section pt-50">
  ...
  <!-- !subscribe -->
    ...
    <section class="page-section pt-50">
	 ...
	 <!-- managers -->
	   <div class="row">   
	   <h2 class="title-section">Спрашивайте информацию по раннему бронированию в <?php echo get_field('kuda'); ?> у менеджеров: </h2>
		  <div class="cws_divider mb-25 mt-5"></div>
