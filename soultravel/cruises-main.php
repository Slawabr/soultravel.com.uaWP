        ...
        <div class="container">
          <div class="call-out-box">
            <div class="call-out-wrap alt">
              <h2 class="title-section alt-2 gray">Подыскать вам круиз?</h2><a href="#"  onclick="$.fancybox('#ordertop');" class="cws-button border-left large alt mb-20">Оставить заявку</a>
            </div>
          </div>
        </div>
      </section>
...
<section class="page-section pt-50">
   ...
   <!-- managers -->
     <div class="row">   
     <h2 class="title-section">Спрашивайте информацию по круизам у менеджеров: </h2>
